                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('department.add_validation') }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            @endphp
                            @for ($i = 0; count($contact_person); $i++)
                                <div class="row mt-2" id="person_{{ $i }}">
                                    ...
                                    <div class="col  col-md-2">
                                        @if ($i == 0)
                                            <button class="btn btn-success btn-sm" type="button" name="add_person"
                                                id="add_person">+</button>
                                        @else
                                            <button type="button"
                                                class="btn btn-danger btn-sm remove_person"data-id="{{ $i }}">-</button>
                                        @endif
                                    </div>
                                </div>
                        </div>
